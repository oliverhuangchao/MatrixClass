...
Vector4d::Vector4d(const Vector3d &v3, double w){
  set(v3, w);
}

Vector2d &Vector2d::operator=(const Vector3d &v3){
  x = v3.x;
  y = v3.y;
  return *this;
}

Vector3d &Vector3d::operator=(const Vector4d &v4){
  x = v4.x;
  y = v4.y;
  z = v4.z;
  return *this;
...
// Projections of vectors into generalized vectors
...
void Vector4d::set(const Vector3d &v3, double w)
{
  x = v3.x;
  y = v3.y;
  z = v3.z;
