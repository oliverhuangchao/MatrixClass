...
public:
  ...
  /* homogenous to 2d coordinate conversion */
  Vector2d &operator=(const Vector3d &v3);
};
...
public:
  ...
  /* homogenous to 3d coordinate conversion */
  Vector3d &operator=(const Vector4d &v4);
};
...
public:
  ...
  Vector4d();
  Vector4d(double vx, double vy, double vz, double vw);
  Vector4d(const Vector4d &v);
  Vector4d(const Vector3d &v, double w = 1.0);
  ...
  void set(const Vector3d &v, double w = 1.0);
